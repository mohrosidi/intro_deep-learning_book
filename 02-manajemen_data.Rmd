...
: (\#tab:recodevar2) Penjelasan jendela Recode Variables.
...
: (\#tab:numtofac2) Penjelasan convert numeric variables to factors.
...
: (\#tab:binvartab) Penjelasan convert numeric variables to factors.
...
: (\#tab:reofac) Penjelasan jendela reorder factor levels.
