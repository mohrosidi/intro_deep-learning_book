...
\hypersetup{unicode=true,
            pdftitle={Analisis Statistika Menggunakan R Commander},
...
\setlength{\droptitle}{-2em}
  ...
  \title{Analisis Statistika Menggunakan R Commander}
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tab:recodevar2} Penjelasan jendela Recode Variables.}\tabularnewline
\toprule
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tab:numtofac2} Penjelasan convert numeric variables to factors.}\tabularnewline
\toprule
\begin{minipage}[b]{0.04\columnwidth}\raggedright
\textbf{No.}\strut
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tab:binvartab} Penjelasan convert numeric variables to factors.}\tabularnewline
\toprule
\begin{minipage}[b]{0.04\columnwidth}\raggedright
\textbf{No.}\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedright
...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tab:reofac} Penjelasan jendela reorder factor levels.}\tabularnewline
\toprule
\begin{minipage}[b]{0.04\columnwidth}\raggedright
\textbf{No.}\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedright
...
\hypertarget{agregasi-variabel-pada-dataset}{%
\subsection{Agregasi Variabel pada Dataset}\label{agregasi-variabel-pada-dataset}}
